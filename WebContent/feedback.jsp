...
<body>
    ...
    <div class="container">
        ...
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Open Feedback</button>
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="thank_you_body">
                            <div class="heading_msg2">
                                <h3>
                                    <span>Thank you Venkat!</span><br> Your feedback was sent perfectly. We will work on it to improve our website.
                                </h3>
